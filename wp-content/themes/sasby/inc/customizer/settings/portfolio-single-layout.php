 ...
 */
class SasbyTheme_Portfolio_Single_Layout_Settings extends SasbyTheme_Customizer {
    ...
    public function register_portfolio_single_layout_controls( $wp_customize ) {
	    ...
	    // Porfolio Single Style
	    $wp_customize->add_setting( 'portfolio_single_style',
		    array(
			    'default' => $this->defaults['portfolio_single_style'],
			    'transport' => 'refresh',
			    'sanitize_callback' => 'rttheme_radio_sanitization',
		    )
	    );
	    $wp_customize->add_control( 'portfolio_single_style',
		    array(
			    'label' => __( 'Portfolio Single Style', 'sasby' ),
			    'section' => 'portfolio_single_layout_section',
			    'description' => esc_html__( 'This is banner background type.', 'sasby' ),
			    'type' => 'select',
			    'choices' => array(
				    '1' => esc_html__( 'Standard Style', 'sasby' ),
				    '2' => esc_html__( 'Slider Style', 'sasby' ),
				    '3' => esc_html__( 'Gallery Style', 'sasby' ),
			    ),
		    )
	    );
        ...
        // Banner BG Type 
        $wp_customize->add_setting( 'portfolio_bgtype',
            array(
                'default' => $this->defaults['portfolio_bgtype'],
                'transport' => 'refresh',
                'sanitize_callback' => 'rttheme_radio_sanitization',
            )
        );
        $wp_customize->add_control( 'portfolio_bgtype',
            array(
        ...
        $wp_customize->add_setting( 'portfolio_bgimg',
            array(
                'default' => $this->defaults['portfolio_bgimg'],
                'transport' => 'refresh',
                'sanitize_callback' => 'absint',
            )
        );
        $wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'portfolio_bgimg',
            array(
        ...
        $wp_customize->add_setting('portfolio_bgcolor', 
            array(
                'default' => $this->defaults['portfolio_bgcolor'],
                'type' => 'theme_mod', 
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'portfolio_bgcolor',
            array(
                'label' => esc_html__('Banner Background Color', 'sasby'),
                'settings' => 'portfolio_bgcolor', 
                'priority' => 10, 
                'section' => 'portfolio_single_layout_section', 
            )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'portfolio_page_bgcolor',
            array(
                ...
                'settings' => 'portfolio_page_bgcolor', 
                'section' => 'portfolio_single_layout_section', 
            )
        ));
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	new SasbyTheme_Portfolio_Single_Layout_Settings();
}
