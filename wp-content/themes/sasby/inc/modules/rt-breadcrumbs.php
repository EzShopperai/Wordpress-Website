...
if( ! function_exists( 'sasby_breadcrumbs' )){

	function sasby_breadcrumbs(){
		...
		$home_text  = esc_html__( 'Home', 'sasby' );
		...
		if ( ! is_home() && ! is_front_page() || is_paged() ){
			...
			elseif ( is_singular() ){
				...
				if ( get_post_type() == 'post' ){
					...
					$category = sasby_get_primary_category_id();
					$category = get_category( $category );
