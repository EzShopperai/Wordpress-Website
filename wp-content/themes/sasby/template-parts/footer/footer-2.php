<?php
$sasby_footer_column = SasbyTheme::$options['footer_column_2'];
...
$copyright_on = (SasbyTheme::$options['copyright_text'] && is_active_sidebar('copyright-menu')) ? "copyright-on" : "copyright-off";
"rt_copyright_menu_no";
?>
<div class="footer-top-area <?php echo esc_attr($bgc); ?>" style="background:<?php echo esc_html($sasby_bg); ?>">
	<?php if (is_active_sidebar('footer-style-2-1') && SasbyTheme::$footer_area == 1) { ?>
