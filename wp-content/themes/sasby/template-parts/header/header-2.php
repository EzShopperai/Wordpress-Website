	...
	<div class="container">
		<div class="menu-full-wrap">
			...
			<div class="header-top-icon">
				<?php if ( SasbyTheme::$options['address_icon'] || SasbyTheme::$options['email_icon'] || SasbyTheme::$options['opening_icon'] || SasbyTheme::$options['phone_icon'] ) { ?>
				<div class="header-info-wrap">
					<?php if ( SasbyTheme::$options['address_icon'] ) { ?>
					<div class="header-info header-address">
						<div class="info-icon address-icon">
							<i class="icon-sasby-location"></i>
						</div>
						<div class="info-text address">
							<span><?php echo wp_kses( SasbyTheme::$options['address_label'] , 'alltext_allow' );?></span><?php echo wp_kses( SasbyTheme::$options['address'] , 'alltext_allow' );?>
						</div>
					</div>
...
<div class="header-menu header-bottom" id="header-menu">
	<div class="container">
		<div class="menu-full-wrap header-dark">
			...
			<?php if ( SasbyTheme::$options['search_icon'] || SasbyTheme::$options['cart_icon'] || SasbyTheme::$options['vertical_menu_icon'] || SasbyTheme::$options['online_button'] ) { ?>
