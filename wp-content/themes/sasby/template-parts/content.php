	...
	<div class="blog-box <?php echo esc_attr($img_class); ?> <?php echo esc_attr($preview); ?>">
		<div class="blog-img-holder">
			<div class="blog-img">
				...
				<?php if ( SasbyTheme::$options['blog_date'] && has_post_thumbnail() ) { ?>
				<h2 class="blog-date">
					<?php echo wp_kses( $sasby_time_html , 'alltext_allow' ); ?>
				</h2>
				<?php } ?>
			</div>				
		</div>
		<div class="entry-content">
			...
			<ul class="entry-meta">
				...
				<?php } if ( SasbyTheme::$options['blog_date'] && empty( has_post_thumbnail() ) ) { ?>	
			...
			<div class="post-read-more"><a class="button-style-3 btn-common" href="<?php the_permalink();?>"><?php esc_html_e( 'Read More ', 'sasby' );?><i class="icon-sasby-right-arrow"></i></a>
          	</div>	
          	<?php } ?>
		</div>
	</div>
