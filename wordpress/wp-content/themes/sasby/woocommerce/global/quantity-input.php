...
if ( $max_value && $min_value === $max_value ) {
    ...
    $label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'sasby' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'sasby' );
    ?>
    <div class="quantity">
        <div class="quantity-item">
        <label class="screen-reader-text" for="<?php echo esc_attr( $input_id ); ?>"><?php echo esc_attr( $label ); ?></label>
        <div class="quantity-label"><?php echo esc_html__('Quantity', 'sasby') ?></div>
        ...
        <input
            ...
            title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'sasby' ); ?>"
            size="4"
