...
?>
<?php if( SasbyTheme::$options['related_woo_product'] && $pro_no > 1 ) { ?>
<div class="rt-related-product products">
	<div class="rt-swiper-slider woo-related-product" data-xld = '<?php echo esc_attr( $swiper_data ); ?>'>
	    <div class="rt-related-title">
			<h2 class="entry-title has-animation"><?php echo wp_kses( SasbyTheme::$options['related_product_title'] , 'alltext_allow' ); ?><span class="titleline"></span></h2>
