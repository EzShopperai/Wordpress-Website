...
if ( ! function_exists( 'rttheme_generate_defaults' ) ) {
    function rttheme_generate_defaults() {
        $customizer_defaults = array(
            ...
            'opening_icon'              => 0,
            'online_button'             => 0,
            'online_button_text'        => esc_html__('Get a Quote', 'sasby'),
            'online_button_link'        => '#',

            'login_icon'                => 0,
            'login_text'                => esc_html__('Login', 'sasby'),
            'login_link'                => '#',

            'offer_icon'                => 0,
            'offer_text'                => esc_html__('Special Offer !', 'sasby'),
            'offer_link'                => '#',
            ...
            'footer_cta_subtitle'       => '',
            'footer_cta_title'          => '',
            'footer_go_it_on'           => 'Go it on',
            'footer_appstore_link'      => '',
            'footer_appstore_text'      => 'App Store',
            'footer_googleplay_text'    => 'Google Play',
            'footer_googleplay_link'    => '',
            'footer_btn_text'           => '',
            'footer_btn_link'           => '',

			//Footer Address
            'footer_number_label'      	=> 'Customer Care',
            'footer_number'      	    => '+18408412569',
            'footer_address'      	    => '202 Helga Springs, Crawford, TN 38554',
            'footer_email_label'      	=> 'Need live support?',
            'footer_email'      		=> 'info@email.com',

			// Footer
            'footer_style'        		=> 1,
            'copyright_text'      		=> '&copy; ' . date('Y') . ' sasby. All Rights Reserved by <a target="_blank" rel="nofollow" href="' . SASBY_AUTHOR_URI . '">RadiusTheme</a>',
			'footer_column_1'			=> 4,
            'footer_column_2'           => 4,
            'footer_column_3'           => 4,
            'footer_column_4'           => 4,
            ...
            'portfolio_archive_breadcrumb' => 0,         
            'portfolio_archive_bgtype' => 'bgcolor',
            'portfolio_archive_bgcolor' => '',
            'portfolio_archive_bgimg' => '',
            'portfolio_archive_page_bgimg' => '',
            'portfolio_archive_page_bgcolor' => '',
            
            //Portfolio Single Layout Setting
	        'portfolio_single_style' => 1,
			...
			'related_product_title' => esc_html__('Related Products', 'sasby'),
			...
			'related_title'				=> esc_html__('You May Also Like', 'sasby'),
			...
			'team_skill' 				=> 1,
            'team_contact'              => 0,
            'team_contact_title'        => esc_html__('Contact Us', 'sasby'),
			'show_related_team' 		=> 1,
			'team_related_title' 		=> esc_html__('Related Chef', 'sasby'),
			'related_team_number' 		=> 5,
			'related_team_title_limit' 	=> 5,

            // Portfolio
            'portfolio_archive_style'     => 'style1',
            'portfolio_post_number'       => 6,
            'portfolio_arexcerpt_limit'   => 20,
            'portfolio_ar_excerpt'        => 0,
            'portfolio_ar_category'       => 1,
            'portfolio_ar_action'         => 1,

            'single_portfolio_cat'        => 1,
            'single_portfolio_client'     => 1,
            'single_portfolio_startdate'  => 1,
            'single_portfolio_enddate'    => 1,
            'single_portfolio_weblink'    => 1,
            'single_portfolio_rating'     => 1,

            'show_related_portfolio'      => 0,
            'portfolio_related_title'     => esc_html__('Related Case', 'sasby'),
            'related_portfolio_number'    => 5,
            'related_portfolio_title_limit'=> 5,
            ...
            'error_text2_color' 		=> '',
			'error_image' 				=> '',
            'error_text1' 				=> esc_html__('Oops... Page Not Found!', 'sasby'),
            'error_text2' 				=> esc_html__('Sorry! This Page Is Not Available!', 'sasby'),
            'error_buttontext' 			=> esc_html__('Go Back To Home Page', 'sasby'),
