...
trait IconTrait {
  ...
  {
    return [
        "icon-sasby-instagram"  => "instagram",
        "icon-sasby-left-arrow"  => "left-arrow",
        "icon-sasby-right-arrow"  => "right-arrow",
        "icon-sasby-location"  => "location",
        "icon-sasby-message"  => "message",
        "icon-sasby-maintain"  => "maintain",
        "icon-sasby-petroleum"  => "petroleum",
        "icon-sasby-quality-control"  => "quality-control",
        "icon-sasby-painter"  => "painter",
        "icon-sasby-pdf"  => "pdf",
        "icon-sasby-phone"  => "phone",
        "icon-sasby-pinterest"  => "pinterest",
        "icon-sasby-play"  => "play",
        "icon-sasby-plus"  => "plus",
        "icon-sasby-power"  => "power",
        "icon-sasby-quote-left"  => "quote-left",
        "icon-sasby-quote-right"  => "quote-right",
        "icon-sasby-rating"  => "rating",
        "icon-sasby-search"  => "search",
        "icon-sasby-select"  => "select",
        "icon-sasby-share"  => "share",
        "icon-sasby-shipping"  => "shipping",
        "icon-sasby-tags"  => "tags",
        "icon-sasby-testing"  => "testing",
        "icon-sasby-time"  => "time",
        "icon-sasby-twitter"  => "twitter",
        "icon-sasby-user"  => "user",
        "icon-sasby-up-arrow"  => "up-arrow",
        "icon-sasby-whatsapp"  => "whatsapp",
        "icon-sasby-worker"  => "worker",
        "icon-sasby-youtube"  => "youtube",
        "icon-sasby-angle-down"  => "angle-down",
        "icon-sasby-angle-left"  => "angle-left",
        "icon-sasby-angle-right"  => "angle-right",
        "icon-sasby-angle-up"  => "angle-up",
        "icon-sasby-architecture"  => "architecture",
        "icon-sasby-automotive"  => "automotive",
        "icon-sasby-calendar"  => "calendar",
        "icon-sasby-calendar-alt"  => "calendar-alt",
        "icon-sasby-cart"  => "cart",
        "icon-sasby-check"  => "check",
        "icon-sasby-comment"  => "comment",
        "icon-sasby-compare"  => "compare",
        "icon-sasby-construction"  => "construction",
        "icon-sasby-docs"  => "docs",
        "icon-sasby-facebook"  => "facebook",
        "icon-sasby-heart" => "heart",
    ];
  }
