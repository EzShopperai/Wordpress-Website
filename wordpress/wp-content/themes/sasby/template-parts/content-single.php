	...
	<div class="main-wrap">
		...
		$sasby_post_gallerys = explode( "," , $sasby_post_gallerys_raw );
			...
			<?php if ( has_post_thumbnail() && ( SasbyTheme::$options['post_featured_image'] == true ) ) { ?>
				<div class="entry-thumbnail-area"><?php the_post_thumbnail( 'sasby-size1' , ['class' => 'img-responsive'] ); ?></div>
			<?php } ?>
		<?php } ?>
		...
		<div class="entry-header">			
			...
			<ul class="entry-meta">				
				...
				<li class="item-author"><i class="icon-sasby-user"></i><?php esc_html_e( 'by ', 'sasby' );?><?php the_author_posts_link(); ?></li>
